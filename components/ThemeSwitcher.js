    ...
    return (
        <div title='Change Theme' class="dropdown dropdown-end">
            <div tabindex="0" class="btn gap-1 normal-case btn-ghost">
                <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="inline-block h-5 w-5 stroke-current tablet:h-6 tablet:w-6">
            ...
            <ul tabindex="0" class="dropdown-content menu p-2 mt-4 shadow bg-base-100 max-h-96 h-64 overflow-y-scroll rounded-box w-52">
                <div className="grid grid-cols-1 gap-3 p-3" tabindex="0">
                    {
                        themeValues.map((theme, index) => {
                            return (
                                <div class="outline-base-content overflow-hidden rounded-lg outline-2 outline-offset-2 outline" data-set-theme={theme} data-act-class="outline">
